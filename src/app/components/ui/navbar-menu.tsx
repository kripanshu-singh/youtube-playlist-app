...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full border border-black/[0.2]  bg-white shadow-input flex justify space-x-4 px-2 py-4 items-center justify-evenly opacity-95 z-[100]"
    >
      {children}
    </nav>
  );
...
export const HoveredLink = ({ children, ...rest }: any) => {
  return (
    <Link {...rest} className="ml-0 pl-0 text-neutral-700 hover:text-black ">
      {children}
    </Link>
  );
};
